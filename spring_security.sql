...
INSERT INTO `sys_menu` VALUES (2, '测试', 'test', 'system/test/test', '0', '0', 'system:test:list', '#', NULL, NULL, NULL, NULL, 0, NULL);
...
INSERT INTO `sys_role` VALUES (4, 'code', 'code', '0', 0, NULL, NULL, NULL, NULL, NULL);
